...
INSERT INTO `wm_comments` (`comment_id`, `comment_authorID`, `comment_authorName`, `comment_authorEmail`, `comment_authorWebsite`, `comment_created`, `comment_text`) VALUES
  ...
  ('8', NULL, 'StanisÅ‚aw KrawÄ™Å¼nik', 'stasiu@kraweznik.biz', 'http://kraweznik.biz', '2010', 'KrawÄ™Å¼niki!!!'),
  ('9', NULL, 'Textilowsky', 'foo@bar.pl', '', '2010', '*Foo!*\r\n\r\n_bar!_\r\n\r\n^4^~2~He^2+^\r\n\r\n&quot;Foo&quot;, \'bar\''),
  ('10', NULL, 'Textilovsky', 'a@b.cc', '', '2010', '\"foo\" \'bar\''),
  ('11', NULL, 'Textilovksy', 'a@b.c', '', '2010', '\" foo \" don\'t'),
...
INSERT INTO `wm_users` (`user_id`, `user_login`, `user_password`, `user_salt`, `user_nick`, `user_email`, `user_lastseen`) VALUES
  ('1', 'radex', 'ac2039247f211bd4e69667aade2e25eac3beecaf', '1234567890123456', '', '', '1287322217');
