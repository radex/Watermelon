...
{
   /*
    * public abstract mixed fetch(mixed $id)
    * 
   ...
   /*
    * public abstract void save(mixed $id, mixed $content)
    * 
   ...
   public abstract function set($id, $content);
   
   /*
    * public abstract void delete(mixed $id[, mixed $id[, ...]])
    * 
    * Deletes $id item(s)
    * 
