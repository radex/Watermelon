...
class Textile_Extension extends Extension
{
   ...
   /*
    * public static void deleteCacheFor(string $text, bool $restricted)
    * 
    * Deletes cached content for $text
    * 
    * bool $restricted - whether $text was generated by textileRestricted method
    */
   
   public static function deleteCacheFor($text, $restricted)
   {
      if($restricted)
      {
         unlink(WM_Cache . 'textile_restricted/' . md5($text) . '.php');
      }
      else
      {
         unlink(WM_Cache . 'textile/' . md5($text) . '.php');
      }
   }
